...
<body>
    <div id="container">
        ...
        <form>
            <h1 class="poppins" style="text-align: center;margin: 40px 0px;font-size:30px;">Otp Verification</h1>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label poppins" style="font-weight:500;font-size:18px;margin:10px auto;width:310px;text-align:center;">Enter the Mobile Verification code</label>
                <div style="display:flex;">
                    <div class="otp_digit"></div>
                    <div class="otp_digit"></div>
                    <div class="otp_digit"></div>
                    <div class="otp_digit"></div>
                </div>
            ...
            <div style="position:absolute;bottom:70px;width:310px;">
                <div style="margin:auto;width:220px;border-radius:5px;box-shadow: 2px 2px white;"><button type="submit" class="btn1">Confirm</button></div>
            </div>
